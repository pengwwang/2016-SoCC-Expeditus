...
static inline  __attribute__((always_inline)) struct trh_hdr *tr_hdr(const struct sk_buff *skb)
{
...
static inline  __attribute__((always_inline)) int arp_fwd_proxy(struct in_device *in_dev, struct rtable *rt)
{
