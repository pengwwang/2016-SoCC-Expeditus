...
typedef  initcall_t  _GLOBAL_286_T; static  _GLOBAL_286_T  __initcall_tcp_scalable_register __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tcp_scalable_register ;       ;
