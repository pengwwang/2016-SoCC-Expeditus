...
typedef  initcall_t  _GLOBAL_287_T; static  _GLOBAL_287_T  __initcall_tcp_veno_register __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tcp_veno_register ;       ;
