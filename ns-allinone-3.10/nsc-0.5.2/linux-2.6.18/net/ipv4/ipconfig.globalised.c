...
typedef  initcall_t  _GLOBAL_312_T; static  _GLOBAL_312_T  __initcall_ip_auto_config __attribute__((__used__)) __attribute__((__section__(".initcall" "7" ".init")))  = ip_auto_config ;       
