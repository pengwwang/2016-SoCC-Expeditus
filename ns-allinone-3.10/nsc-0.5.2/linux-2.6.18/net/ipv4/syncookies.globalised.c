...
typedef  initcall_t  _GLOBAL_288_T; static  _GLOBAL_288_T  __initcall_init_syncookies __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = init_syncookies ;       ;
