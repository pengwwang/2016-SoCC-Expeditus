...
# 1 "/proj/expeditus/ns-allinone-3.10/nsc-0.5.2//"
# 1 "<built-in>"
# 1 "<command-line>"
...
typedef  initcall_t  _GLOBAL_304_T; static  _GLOBAL_304_T  __initcall_bictcp_register __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = bictcp_register ;       ;
