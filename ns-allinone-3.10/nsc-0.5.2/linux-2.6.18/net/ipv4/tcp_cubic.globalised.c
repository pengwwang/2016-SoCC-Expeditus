...
typedef  initcall_t  _GLOBAL_307_T; static  _GLOBAL_307_T  __initcall_cubictcp_register __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = cubictcp_register ;       ;
