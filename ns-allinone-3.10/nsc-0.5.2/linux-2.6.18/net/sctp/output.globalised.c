...
void sctp_packet_free(struct sctp_packet *packet)
{
 ...
 for (chunk = ({ const typeof( ((typeof(*chunk) *)0)->list ) *__mptr = ((&packet->chunk_list)->next); (typeof(*chunk) *)( (char *)__mptr - __builtin_offsetof(typeof(*chunk),list) );}), tmp = ({ const typeof( ((typeof(*chunk) *)0)->list ) *__mptr = (chunk->list.next); (typeof(*chunk) *)( (char *)__mptr - __builtin_offsetof(typeof(*chunk),list) );}); &chunk->list != (&packet->chunk_list); chunk = tmp, tmp = ({ const typeof( ((typeof(*tmp) *)0)->list ) *__mptr = (tmp->list.next); (typeof(*tmp) *)( (char *)__mptr - __builtin_offsetof(typeof(*tmp),list) );})) {
...
int sctp_packet_transmit(struct sctp_packet *packet)
{
 ...
 chunk = ({ const typeof( ((struct sctp_chunk *)0)->list ) *__mptr = (packet->chunk_list.next); (struct sctp_chunk *)( (char *)__mptr - __builtin_offsetof(struct sctp_chunk,list) );});
 sk = chunk->skb->sk;
