...
static inline  __attribute__((always_inline)) int udp_lport_inuse(u16 num)
{
 ...
 for (node = (&(*_GLOBAL_udp_hash_44_A[get_stack_id()])[num & (128 - 1)])->first; node && ({ prefetch(node->next); 1;}) && ({ sk = ({ const typeof( ((typeof(*sk) *)0)->__sk_common.skc_node ) *__mptr = (node); (typeof(*sk) *)( (char *)__mptr - __builtin_offsetof(typeof(*sk),__sk_common.skc_node) );}); 1;}); node = node->next)
...
gotit:
  ...
  for (node = (&(*_GLOBAL_udp_hash_44_A[get_stack_id()])[snum & (128 - 1)])->first; node && ({ prefetch(node->next); 1;}) && ({ sk2 = ({ const typeof( ((typeof(*sk2) *)0)->__sk_common.skc_node ) *__mptr = (node); (typeof(*sk2) *)( (char *)__mptr - __builtin_offsetof(typeof(*sk2),__sk_common.skc_node) );}); 1;}); node = node->next)
                                                {
      ...
      struct in6_addr *daddr, u16 dport, int dif)
{
 ...
 for (node = (&(*_GLOBAL_udp_hash_44_A[get_stack_id()])[hnum & (128 - 1)])->first; node && ({ prefetch(node->next); 1;}) && ({ sk = ({ const typeof( ((typeof(*sk) *)0)->__sk_common.skc_node ) *__mptr = (node); (typeof(*sk) *)( (char *)__mptr - __builtin_offsetof(typeof(*sk),__sk_common.skc_node) );}); 1;}); node = node->next) {
    ...
    struct msghdr *msg, size_t len)
{
 ...
 if (sin6) {
  if (addr_len < __builtin_offsetof(struct sockaddr,sa_data))
   return -22;
