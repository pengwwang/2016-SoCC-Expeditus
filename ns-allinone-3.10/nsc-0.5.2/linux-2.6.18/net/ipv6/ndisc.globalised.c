...
static inline  __attribute__((always_inline)) int ndisc_opt_addr_space(struct net_device *dev)
{
...
static inline  __attribute__((always_inline)) u8 *ndisc_opt_addr_data(struct nd_opt_hdr *p,
          struct net_device *dev)
{
 u8 *lladdr = (u8 *)(p + 1);
...
static inline  __attribute__((always_inline)) void ndisc_flow_init(struct flowi *fl, u8 type,
