 ...
 * 
 * Changed by Hong Xu, 2014, to incorporate sp-net-device code from ns3-dcn
 */
...
// private:
// Changed from private to protected for compatibility with sp-net-device from ns-dcn code  
protected:
  /**
