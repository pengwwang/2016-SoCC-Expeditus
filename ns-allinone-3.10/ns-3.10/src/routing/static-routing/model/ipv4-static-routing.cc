...
Ptr<Ipv4Route> 
Ipv4StaticRouting::RouteOutput (Ptr<Packet> p, Ipv4Header &header, Ptr<NetDevice> oif, Socket::SocketErrno &sockerr)
{
...
bool 
Ipv4StaticRouting::RouteInput  (Ptr<Packet> p, Ipv4Header &ipHeader, Ptr<const NetDevice> idev,
