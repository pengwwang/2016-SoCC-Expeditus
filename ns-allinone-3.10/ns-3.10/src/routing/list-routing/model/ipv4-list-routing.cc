...
bool 
Ipv4ListRouting::RouteInput (Ptr<Packet> p, Ipv4Header &header, Ptr<const NetDevice> idev, 
...
public:
  ...
  bool RouteInput  (Ptr<Packet> p, Ipv4Header &header, Ptr<const NetDevice> idev,
                             UnicastForwardCallback ucb, MulticastForwardCallback mcb,
