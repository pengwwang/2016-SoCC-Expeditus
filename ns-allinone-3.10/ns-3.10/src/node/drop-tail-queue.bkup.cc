...
//void
//DropTailQueue::ClearValue ()
//{
//  std::cout << "clear at: " <<  Simulator::Now().GetSeconds() << " congestion: " << m_CongestionLevel << std::endl;
//  m_SamplePackets = 0; 
//  Simulator::Schedule (MicroSeconds(500), &DropTailQueue::ClearValue, this);
//}  
...
// m_samplepackets increases with packet arrival in sample interval
//m_SamplePackets++;
// congestion level
//m_CongestionLevel = m_SamplePackets/15;
//if (m_StartSample)
//{
//   m_StartSample = false; 
//   ClearValue ();
